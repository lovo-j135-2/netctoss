...
public interface LoginLogMapper {
	...
	@Select(value="select * from t_loginlog where login_time between #{bt} and #{et} limit #{pb.index},#{pb.rows}")
	@ResultType(LoginLogBean.class)	//分页返回一个LoginLogPageBean对象？？
	public List<LoginLogBean> findLoginLogBeanByTimeToPage(@Param("pb")LoginLogPageBean pageBean,@Param("bt")String beginTime,@Param("et")String endTime) throws Exception;
	
	@Select(value="select count(*) from t_loginlog where login_time between #{bt} and #{et}")
	@ResultType(Integer.class)
	public int findCountLoginLogBeanByTimeToPage(@Param("bt")String beginTime,@Param("et")String endTime);
	
	
	@Select(value="select * from t_loginlog where login_time between #{bt} and #{et}")
	@Results({
	...
	public List<LoginLogBean> findAllLoginLogBeanByTimeToPage(@Param("bt")String beginTime,@Param("et")String endTime);
